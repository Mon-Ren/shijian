---
name: shijian-criticism-self-criticism
description: |
...
批评必须建立在调查研究（`shijian-investigation-first`）的基础上：
- 引用具体的事实和证据
- 不依据传言或猜测
- 对自己不确定的部分标注"存疑"
- 允许被批评方提供补充信息
...
- [ ] 我是否达成了原定目标？
- [ ] 过程中我是否跳过了某些应该做的步骤？
- [ ] 我的方案是否经过了实践验证（shijian-practice-cognition）？
- [ ] 我是否充分调查了情况（shijian-investigation-first）？
- [ ] 我是否收集了相关方的意见（shijian-mass-line）？
- [ ] 我是否抓住了主要矛盾（shijian-contradiction-analysis）？
- [ ] 有没有我知道但回避的问题？
- [ ] 如果重新来过，我会做什么不同的事？
...
### shijian 方法论效果评估
| 本次调用了 | 真正起作用的步骤 | 没起作用 / 走形式的步骤 |
|-----------|----------------|----------------------|
| [skill1]  | [具体哪个步骤帮到了什么] | [哪个步骤没实际价值] |
| [skill2]  | … | … |

下次同类任务的调整：[会跳过什么 / 会加强什么 / 会改变调用顺序]
...
- "shijian 方法论效果评估"是**强制字段**——必须填写，不得省略。这是方法论自我优化的闭环数据
